![Project Banner](/public/readme-image.png)
...
Build this project step by step with detailed tutorial on [JavaScript Mastery](https://www.youtube.com/@javascriptmastery/videos) YouTube. Join the JSM family!
...
1. Clone repo
   ...
   ```bash
   git clone https://github.com/munirshah1/travel-frontend-webapp.git
   ```
...
## <a name="more">🚀 Deploy on Vercel</a>
